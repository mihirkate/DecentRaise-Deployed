      ...
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="relative flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <Link
              href="/whitepaper"
              className="mr-4 font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400"
            >
              Whitepaper
            </Link>
            <Link
          ...
          <div className="lg:hidden z-40">
            ...
            {isMenuOpen && (
              <div className="absolute top-0 left-0 w-full bg-white p-5 border rounded shadow-sm">
